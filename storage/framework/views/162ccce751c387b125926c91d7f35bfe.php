        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card border-0 shadow-sm rounded" style="background: #393939;">
                    <div class="card-body">
                        <img src="<?php echo e(asset('storage/posts/'.$post->image)); ?>" class="w-100 rounded mb-4">
                        <h4 style="color: #000;"><?php echo e($post->title); ?></h4>
                        <p style="color: #000;"><?php echo $post->content; ?></p>
                        <hr>
...
<?php /**PATH C:\xampp\htdocs\motogaleri\resources\views/posts/show.blade.php ENDPATH**/ ?>