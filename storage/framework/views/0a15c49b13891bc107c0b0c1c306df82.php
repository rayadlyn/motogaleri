...
<head>
    ...
    <style>
        ...
        .navbar {
            ...
            padding: 10px 0;
            /* Tambahkan padding di atas dan bawah */
        }
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 penjelasan">
                ...
                <p>Moto Galeri adalah situs web yang didedikasikan untuk para pecinta dunia permotoran. Kami menyediakan
                    berbagai informasi terbaru seputar motor, seperti galeri foto motor terbaru, ulasan motor.</p>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\motogaleri\resources\views/welcome.blade.php ENDPATH**/ ?>