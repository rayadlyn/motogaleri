                        ...
                        <form method="POST" action="<?php echo e(route('login')); ?>">
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <p class="mt-3" style="color: white;">Belum punya akun? <a href="<?php echo e(route('register')); ?>" style="color: primary;">Register</a></p> <!-- Tambahkan pesan untuk register -->
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\galeri\resources\views/auth/login.blade.php ENDPATH**/ ?>