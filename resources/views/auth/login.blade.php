    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #393939;">
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('welcome') }}" style="color: #000;">Kembali</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <p class="mt-3" style="color: white;">Belum punya akun? <a href="{{ route('register') }}" style="color: primary;">Register</a></p> <!-- Tambahkan pesan untuk register -->
                                </div>
                            </div>
                        </form>
                    </div>
